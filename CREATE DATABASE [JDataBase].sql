...
GO
INSERT [dbo].[tDetalle] ([Consecutivo], [ConsecutivoFactura], [ConsecutivoProducto], [Precio], [Cantidad], [Total]) VALUES (1, 1, 3, CAST(225000.00 AS Decimal(18, 2)), 1, CAST(225000.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[tDetalle] ([Consecutivo], [ConsecutivoFactura], [ConsecutivoProducto], [Precio], [Cantidad], [Total]) VALUES (2, 1, 4, CAST(50000.00 AS Decimal(18, 2)), 1, CAST(50000.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[tDetalle] ([Consecutivo], [ConsecutivoFactura], [ConsecutivoProducto], [Precio], [Cantidad], [Total]) VALUES (3, 1, 5, CAST(225000.00 AS Decimal(18, 2)), 1, CAST(225000.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[tDetalle] ([Consecutivo], [ConsecutivoFactura], [ConsecutivoProducto], [Precio], [Cantidad], [Total]) VALUES (4, 1, 6, CAST(50000.00 AS Decimal(18, 2)), 1, CAST(50000.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[tDetalle] ([Consecutivo], [ConsecutivoFactura], [ConsecutivoProducto], [Precio], [Cantidad], [Total]) VALUES (5, 2, 3, CAST(225000.00 AS Decimal(18, 2)), 2, CAST(450000.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[tDetalle] ([Consecutivo], [ConsecutivoFactura], [ConsecutivoProducto], [Precio], [Cantidad], [Total]) VALUES (6, 3, 5, CAST(225000.00 AS Decimal(18, 2)), 2, CAST(450000.00 AS Decimal(18, 2)))
GO
...
GO
INSERT [dbo].[tFactura] ([Consecutivo], [ConsecutivoUsuario], [Total], [Fecha]) VALUES (1, 8, CAST(550000.00 AS Decimal(18, 2)), CAST(N'2024-12-12T20:18:33.293' AS DateTime))
GO
INSERT [dbo].[tFactura] ([Consecutivo], [ConsecutivoUsuario], [Total], [Fecha]) VALUES (2, 8, CAST(450000.00 AS Decimal(18, 2)), CAST(N'2024-12-12T20:28:09.150' AS DateTime))
GO
INSERT [dbo].[tFactura] ([Consecutivo], [ConsecutivoUsuario], [Total], [Fecha]) VALUES (3, 8, CAST(450000.00 AS Decimal(18, 2)), CAST(N'2024-12-12T20:28:22.360' AS DateTime))
GO
...
GO
INSERT [dbo].[tProducto] ([Consecutivo], [Nombre], [Precio], [Inventario], [Imagen], [Activo]) VALUES (3, N'XBox 360.3', CAST(225000.00 AS Decimal(18, 2)), 0, N'/products/', 1)
GO
INSERT [dbo].[tProducto] ([Consecutivo], [Nombre], [Precio], [Inventario], [Imagen], [Activo]) VALUES (4, N'XBox 360.4', CAST(50000.00 AS Decimal(18, 2)), 0, N'/products/', 1)
GO
INSERT [dbo].[tProducto] ([Consecutivo], [Nombre], [Precio], [Inventario], [Imagen], [Activo]) VALUES (5, N'XBox 360.5', CAST(225000.00 AS Decimal(18, 2)), 0, N'/products/', 1)
GO
INSERT [dbo].[tProducto] ([Consecutivo], [Nombre], [Precio], [Inventario], [Imagen], [Activo]) VALUES (6, N'XBox 360.6', CAST(50000.00 AS Decimal(18, 2)), 0, N'/products/', 1)
GO
...
BEGIN
	...
	INSERT INTO dbo.tDetalle (ConsecutivoFactura,ConsecutivoProducto,Precio,Cantidad,Total)
    SELECT 	@@IDENTITY, C.ConsecutivoProducto, P.Precio, C.Unidades, (C.Unidades * P.Precio)
	FROM	tCarrito C
	INNER JOIN tProducto P ON C.ConsecutivoProducto = P.Consecutivo
	WHERE C.ConsecutivoUsuario = @ConsecutivoUsuario
	...
	UPDATE	P
	SET		P.Inventario = P.Inventario - C.Unidades
	FROM	tProducto P
